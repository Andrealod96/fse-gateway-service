...
public class ApiExceptionHandler {
    ...
    @ExceptionHandler(it.thcs.fse.fsersaservice.infrastructure.gateway.exception.GatewayClientException.class)
    public ResponseEntity<ApiErrorResponse> handleGatewayClientException(
            it.thcs.fse.fsersaservice.infrastructure.gateway.exception.GatewayClientException ex,
            ServerWebExchange exchange
    ) {
    ...
    @ExceptionHandler(it.thcs.fse.fsersaservice.infrastructure.gateway.exception.GatewayTransportException.class)
    public ResponseEntity<ApiErrorResponse> handleGatewayTransportException(
            it.thcs.fse.fsersaservice.infrastructure.gateway.exception.GatewayTransportException ex,
            ServerWebExchange exchange
    ) {
