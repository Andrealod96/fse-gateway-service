...
public class GatewayTransactionStatusApplicationService {
    ...
    public GatewayTransactionStatusApplicationService(FseGatewayClient fseGatewayClient) {
    ...
    public Mono<GatewayTransactionStatusResponse> getByWorkflowInstanceId(String workflowInstanceId) {
        ...
        return fseGatewayClient.getStatusByWorkflowInstanceId(normalizedWorkflowInstanceId)
                .map(this::toResponse);
    }
