...
public class CdaHeaderFragmentBuilder {
    ...
    public String build(RsaDocument rsaDocument, String documentIdExtension, String generationTimeValue) {
        ...
        /*
         * CT27 KO:
         * consente di generare un CDA privo di confidentialityCode.
         *
         * Nei casi normali il campo deve SEMPRE essere presente.
         */
        if (!Boolean.TRUE.equals(rsaDocument.getOmitConfidentialityCode())) {
